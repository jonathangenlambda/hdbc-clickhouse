...
import Database.HDBC.ClickHouse.Protocol (Config, joinSqlValues)
...
readValue sock (DateTime64 _ _size) _ numRows =
    readEachValue numRows $ fmap toSql $ D.readDateTime64 sock -- TODO: timezone
