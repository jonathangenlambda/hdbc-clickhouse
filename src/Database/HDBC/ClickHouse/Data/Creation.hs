...
createColumn name typ
    | isPrefixOf "DateTime64(" typ && isSuffixOf ")" typ =
        DateTime64{columnName = name, precision = getDateTime64Precision typ}
...
getDateTime64Precision :: String -> Int
getDateTime64Precision typ =
    read $ (drop (length "DateTime64(") . init) typ
